defmodule Tattle.Api.Token do
  ...
  def sign(data) do
    IO.puts("Inside SIGN")
    token = Phoenix.Token.sign(TattleWeb.Endpoint, @signing_salt, data)
  ...
  def verify(token) do
    case Phoenix.Token.verify(TattleWeb.Endpoint, @signing_salt, token,
